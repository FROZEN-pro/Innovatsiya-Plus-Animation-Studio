...
export const translations: Record<LanguageCode, Record<string, string>> = {
  ...
  ru: {
    ...
    generateGemini: "Сгенерировать Описание через Gemini 3.7 Flash",
    geminiGenerating: "Gemini 3.7 Flash AI Анализирует...",
